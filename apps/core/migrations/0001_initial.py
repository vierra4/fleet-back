    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('driver', 'Driver'), ('client', 'Client')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequent_location', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('job_offered', 'Job Offered'), ('cancelled', 'Cancelled'), ('completed', 'Completed'), ('in_progress', 'In Progress'), ('on_hold', 'On Hold')], default='pending', max_length=100)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequent_location', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_bid', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='job_offer', to='core.jobbid')),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.car')),
                ('job_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.jobpost')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.AddField(
            model_name='jobbid',
            name='job_post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bids', to='core.jobpost'),
        ),
        migrations.AddField(
            model_name='chatroom',
            name='job_post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='core.jobpost'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_offer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.joboffer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='chatroom',
            name='client',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='core.client'),
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
        ...
        migrations.AddField(
            model_name='chatroom',
            name='driver',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='core.driver'),
        ),
        migrations.AddField(
            model_name='car',
            name='driver',
